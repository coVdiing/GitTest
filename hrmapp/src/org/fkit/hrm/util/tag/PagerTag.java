		...
		if (recordCount > 0) {
			...
			if(this.pageIndex == 1) {//首页
				...
				if(this.pageIndex == totalPage) {
				 ...
				 String tempUrl = this.submitUrl.replaceAll(TAG, String.valueOf(pageIndex+1));
			...
			res.append("<tr><td style='color:#0061;margin-right:3px;padding-top:2px;text-decoration:none'>"+str.toString());
			res.append("&nbsp;跳 转 到 &nbsp;&nbsp;<input style='text-align:center;border-right:#aaaadd 1px solid;"
					+ "padding-right:5px;border-top:#aaaadd 1px solid;padding-left:5px;padding-bottom:2px;margin:2px;"
					+ "border-left:#aaaadd 1px solid;color:#000099;padding-top:2px;border-bottom:#aaaadd 1px solid;"
					+ "text-decoration:none' type='text' size='2' id='pager_jump_page_size'/>");
			res.append("&nbsp;<input type='button' style='text-align:center;border-right:#dedfde 1px solid;padding-right:6px;"
					...
					+ "text-decoration:none' value='确 定' id='pager_jump_btn'/>");
			res.append("</td></tr>");
			res.append("<tr align='center' style='font-size:13px;'><td style='color:#0061de;margin-right:3px;padding-top:2px;text-decoration:none'>");
			//开始条数
